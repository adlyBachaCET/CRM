...
namespace CRM.Data.Repositories
{
    public class RequestDoctorRepository : Repository<RequestDoctor>, IRequestDoctorRepository
    {
        ...
        {
            var result = await MyDbContext.RequestDoctors.Where(a => a.Active == 0 && a.IdPharmacy == id).ToListAsync();
            return result;
        }
        ...
        {
            var result = await MyDbContext.RequestDoctors.Where(a => a.Active == 0 && a.IdUser == id).ToListAsync();
            return result;
        }
